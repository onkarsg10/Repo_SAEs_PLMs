...
class UniRefDataset(Dataset):
    def __init__(self, uniref_file, esm_model, alphabet, device, esm_layer, max_seq_len, seed_only=False, max_samples=50000000, return_difference=False):
    ...
    def __getitem__(self, idx):
        ...
        if self.return_difference:
            return current_embedding, difference_embedding, metadata, seq
        else:
            return current_embedding, next_embedding, metadata, seq
